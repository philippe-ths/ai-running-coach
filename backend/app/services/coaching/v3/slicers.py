...
from app.schemas import VerdictScorecardResponse, LeverResponse
...
def slice_for_next_steps(
    ...
    return {
        "current_status": {
            "verdict": scorecard_result.headline.status,
...
def slice_for_question(
    ...
    return {
        ...
        "verdict_theme": scorecard_result.headline.sentence,
        "pain_points": [
